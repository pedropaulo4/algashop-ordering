...
class OrderTest {
    ...
    @Test
    public void giveDraftOrder_whenPlace_shouldChangeToPlaced() {
    ...
    @Test
    public void giveDraftOrder_whenTryToPlace_shouldGenerateException() {
    ...
    @Test
    public void givenDraftOrderAndDeliveryDateInThePast_whenChangeShipping_shouldAllowChange() {
