...
public class ErrorMessages {
    ...
    public static final String ERROR_STATUS_CANNOT_BE_CHANGED = "Cannot change order %s status from %s to %s";
    ...
    public static final String ERROR_ORDER_CANNOT_BE_PLACED_HAS_NO_ITEMS =
            "Order %s cannot be placed, it has not items";
    ...
    public static final String ERROR_ORDER_CANNOT_BE_PLACED_INVALID_PAYMENT_METHOD =
