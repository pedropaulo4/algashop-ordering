package com.algaworks.algashop.ordering.infrastructure.utility.modalmapper;
...
public class ModelMapperConfig {
    ...
    private static final Converter<BirthDate, LocalDate> birthNameToLocalDateConverter =
            mappingContext -> {
    ...
    private void configuration(ModelMapper modelMapper) {
        ...
        modelMapper.createTypeMap(Customer.class, CustomerOutput.class)
                ...
                .addMappings(mapping ->
                        mapping.using(birthNameToLocalDateConverter).map(Customer::birthDate, CustomerOutput::setBirthDate));
