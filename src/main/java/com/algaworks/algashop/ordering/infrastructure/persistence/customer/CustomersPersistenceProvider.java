...
public class CustomersPersistenceProvider implements Customers {
    ...
    @Override
    public boolean isEmailUnique(Email email, CustomerId expectedCustomerId) {
        return !persistenceRepository.existsByEmailAndIdNot(email.value(), expectedCustomerId.value());
    }
}