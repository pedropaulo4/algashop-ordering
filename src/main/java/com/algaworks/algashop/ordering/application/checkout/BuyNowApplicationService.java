...
import com.algaworks.algashop.ordering.infrastructure.product.client.fake.ProductCatalogService;
...
public class BuyNowApplicationService {
    ...
    public String buyNow(BuyNowInput input) {
        ...
        Shipping shipping = shippingInputDisassembler.toDomainModel(
                input.getShipping(),
